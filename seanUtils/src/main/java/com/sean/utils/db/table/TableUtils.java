...
import com.sean.utils.db.annotation.Table;
...
public class TableUtils {
     ...
     * key: entityType.name
     */
    private static ConcurrentHashMap<String, com.sean.utils.db.table.Id> entityIdMap = new ConcurrentHashMap<String, com.sean.utils.db.table.Id>();

    /* package */
    static synchronized com.sean.utils.db.table.Id getId(Class<?> entityType) {
        ...
        com.sean.utils.db.table.Id id = new com.sean.utils.db.table.Id(entityType, primaryKeyField);
        entityIdMap.put(entityType.getName(), id);
        return id;
    }

    private static String getPrimaryKeyFieldName(Class<?> entityType) {
        com.sean.utils.db.table.Id id = getId(entityType);
