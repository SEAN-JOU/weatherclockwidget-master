...
import com.sean.utils.db.sqlite.*;
import com.sean.utils.db.table.DbModel;
import com.sean.utils.db.table.Id;
import com.sean.utils.db.table.Table;
import com.sean.utils.db.table.TableUtils;
import com.sean.utils.exception.DbException;
import com.sean.utils.util.IOUtils;
...
public class DbUtils {
    ...
    public void update(Object entity, EditText id, EditText email, EditText name, String... updateColumnNames) throws DbException {
        if (!tableIsExist(entity.getClass())) return;
        try {
            beginTransaction();
    ...
    public void update(Object entity, String whereBuilder, String updateColumnNames, String name) throws DbException {
        if (!tableIsExist(entity.getClass())) return;
        try {
            beginTransaction();
